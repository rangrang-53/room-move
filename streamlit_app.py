...
def get_ai_response(question: str) -> str:
    ...
    knowledge_base = {
        ...
        "이삿짐": "이삿짐 센터는 최소 1주일 전에 예약하시는 것이 좋습니다. 주말이나 월말에는 더 일찍 예약해야 합니다. 여러 업체의 견적을 비교해보세요.",
...
def get_movers(region: Optional[str] = None) -> List[Dict]:
    movers_data = [
        {"id": 1, "name": "용달이사 전문", "region": "서울 강남구", "phone": "02-1234-5678", "rating": 4.5, "price_range": "30-50만원"},
        {"id": 2, "name": "친절한 이사", "region": "서울 강남구", "phone": "02-2345-6789", "rating": 4.8, "price_range": "40-60만원"},
        {"id": 3, "name": "빠른 포장이사", "region": "서울 서초구", "phone": "02-3456-7890", "rating": 4.3, "price_range": "50-80만원"},
        {"id": 4, "name": "1인가구 전문", "region": "서울 강남구", "phone": "02-4567-8901", "rating": 4.7, "price_range": "25-40만원"},
        {"id": 5, "name": "저렴한 이사", "region": "서울 송파구", "phone": "02-5678-9012", "rating": 4.2, "price_range": "20-35만원"},
    ]

    if region:
        return [m for m in movers_data if region in m["region"]]
    return movers_data
